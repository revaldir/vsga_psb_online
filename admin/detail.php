<?php
    ...
    // Query
    $query = mysqli_query($koneksi, "SELECT * FROM data_pendaftaran INNER JOIN users ON data_pendaftaran.user_id = users.user_id WHERE data_pendaftaran.user_id = '$_GET[user_id]'");
